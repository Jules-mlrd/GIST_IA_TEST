  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <main className="flex-1 w-full flex flex-col items-center justify-center py-10 px-2">
        <Card className="w-full max-w-xl mx-auto p-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg flex flex-col items-center">
          ...
          <p className="text-base text-gray-700 dark:text-gray-300 mb-1 font-medium">Gestion des Imputations et Suivi Travaux</p>
          <p className="text-center text-gray-600 dark:text-gray-400 text-lg mb-6 max-w-md">
          ...
          {/* Test du thème - à supprimer après test */}
          ...
          <div className="flex flex-col gap-4 w-full mt-2">
            ...
            <Link href="/home-page" className="w-full">
              <Button className="w-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-[#E2001A] dark:text-[#E2001A] text-base font-medium py-3 rounded-md shadow">Aide &amp; Documentation</Button>
            </Link>
          </div>
        </Card>
      </main>
